...
#include <stdint.h>
   ...
   */
  void asm_shabal_init(asm_shabal_context *sc, unsigned out_size);
   ...
   */
  void asm_shabal(asm_shabal_context *sc, const void *data, size_t len);
   ...
   */
  void asm_shabal_close(asm_shabal_context *sc, unsigned ub, unsigned n, void *dst);
